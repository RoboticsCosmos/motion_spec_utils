...
public:
     ...
     */
    int CartToJnt(const JntArray &q, const JntArray &q_dot, JntArray &q_dotdot, 
                  const Jacobian& alfa, const JntArray& beta, 
...
private:
     ...
     */
    void initial_upwards_sweep(const JntArray &q, const JntArray &q_dot, 
...
private:
    ...
    struct segment_info
    {
        ...
        Wrench ext_virtual_force; // virtual external rigid-body forces expressed in segment's tip frame.
        Wrench F_ext_virtual; // virtual external articulated-body forces. without tilde means expressed at the joint root (the childs tip!!!)
        Wrench F_ext_virtual_tilde; // virtual external articulated-body forces. tilde is in the segment ref-frame (tip, not joint root)
        Twist C; //constraint
        Twist A; //constraint
